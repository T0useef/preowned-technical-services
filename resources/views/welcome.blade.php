        ...
        <div class="row g-4 projects-grid">
          <div class="col-6 col-md-3">
            <article class="project-card">
              <img src="{{asset('assets/images/vegetable-market.jpg')}}" alt="Vegetable & Fruit Market project" class="project-card-img" loading="lazy">
          ...
          <div class="col-6 col-md-3">
            <article class="project-card">
              <img src="{{asset('assets/images/dubai-municipality-office.jpg')}}" alt="Dubai Municipality Office project" class="project-card-img" loading="lazy">
              <div class="project-card-overlay">
